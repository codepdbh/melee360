...
typedef struct M360MatchStatus {
    ...
    unsigned fighters;
    unsigned damage[4];
    unsigned stocksLost[4];
    unsigned stocksRemaining[4];
    unsigned motion[4];
    unsigned human[4];
    unsigned matchOver;
    unsigned winner;
    ...
    float inputX, inputY;
    unsigned selecting;
    unsigned selectKind[4];
    unsigned selectCostume[4];
    unsigned selectReady[4];
    unsigned selectHuman[4];
    unsigned fighterKind[4];
    unsigned stageIndex;
    unsigned stocks;
    unsigned cpuLevel;
    unsigned slotCount;
